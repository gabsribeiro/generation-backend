...
public class ControllerPost {
	...
	public ResponseEntity<List<Post>> findByTitleI(@PathVariable(value = "title") String title) {
	...
	@GetMapping("/search")
	public ResponseEntity<List<Post>> findByTitleII(@RequestParam(defaultValue = "") String title) {
		List<Post> listObject = repository.findAllByTitleContainingIgnoreCase(title);
